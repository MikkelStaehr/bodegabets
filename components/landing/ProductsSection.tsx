...
const PRODUCT_CARDS = [
  ...
  },
  {
    ...
    description:
      'Tip vinderne på tværs af 20 europæiske ligaer. Bet-vinduet låser 30 minutter før kickoff, og konsensus-odds belønner dig op til ×1.8 for at gå mod strømmen.',
    features: [
