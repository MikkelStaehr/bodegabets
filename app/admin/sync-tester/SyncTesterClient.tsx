                      ...
                      >
                        ...
                        <span className="text-[#7a7060]">
                          ...
                          {r.first_kickoff && r.last_kickoff && (
                            <> · {new Date(r.first_kickoff).toLocaleDateString('da-DK', { timeZone: 'UTC', day: 'numeric', month: 'short' })} – {new Date(r.last_kickoff).toLocaleDateString('da-DK', { timeZone: 'UTC', day: 'numeric', month: 'short' })}</>
                          )}
                        </span>
                      </div>
                    ))}
