...
RACES = [
    # Grand Tours
    {"name": "Tour de France", "pcs_slug": "tour-de-france", "race_type": "stage_race", "profile": "mountain", "year": YEAR, "start_date": "2026-07-04"},
    {"name": "Giro d'Italia", "pcs_slug": "giro-d-italia", "race_type": "stage_race", "profile": "mountain", "year": YEAR, "start_date": "2026-05-09"},
    {"name": "Vuelta a España", "pcs_slug": "vuelta-a-espana", "race_type": "stage_race", "profile": "mountain", "year": YEAR, "start_date": "2026-08-15"},
    # Stage races
    {"name": "Paris-Nice", "pcs_slug": "paris-nice", "race_type": "stage_race", "profile": "mixed", "year": YEAR, "start_date": "2026-03-08"},
    {"name": "Tirreno-Adriatico", "pcs_slug": "tirreno-adriatico", "race_type": "stage_race", "profile": "mixed", "year": YEAR, "start_date": "2026-03-11"},
    ...
    {"name": "Ronde van Vlaanderen", "pcs_slug": "ronde-van-vlaanderen", "race_type": "one_day", "profile": "cobbled", "year": YEAR, "start_date": "2026-04-05"},
    {"name": "Paris-Roubaix", "pcs_slug": "paris-roubaix", "race_type": "one_day", "profile": "cobbled", "year": YEAR, "start_date": "2026-04-12"},
    {"name": "Liège-Bastogne-Liège", "pcs_slug": "liege-bastogne-liege", "race_type": "one_day", "profile": "hilly", "year": YEAR, "start_date": "2026-04-26"},
    {"name": "Il Lombardia", "pcs_slug": "il-lombardia", "race_type": "one_day", "profile": "hilly", "year": YEAR, "start_date": "2026-10-10"},
    # Championships
    {"name": "World Championships", "pcs_slug": "world-championship", "race_type": "one_day", "profile": "mixed", "year": YEAR, "start_date": "2026-09-20"},
    {"name": "European Championships", "pcs_slug": "european-championship", "race_type": "one_day", "profile": "mixed", "year": YEAR, "start_date": "2026-09-13"},
    # Classics — cobbled
    {"name": "Omloop Het Nieuwsblad", "pcs_slug": "omloop-het-nieuwsblad", "race_type": "one_day", "profile": "cobbled", "year": YEAR, "start_date": "2026-02-28"},
    {"name": "Strade Bianche", "pcs_slug": "strade-bianche", "race_type": "one_day", "profile": "mixed", "year": YEAR, "start_date": "2026-03-07"},
    {"name": "E3 Classic", "pcs_slug": "e3-saxo-bank-classic", "race_type": "one_day", "profile": "cobbled", "year": YEAR, "start_date": "2026-03-27"},
    {"name": "Gent-Wevelgem", "pcs_slug": "gent-wevelgem", "race_type": "one_day", "profile": "cobbled", "year": YEAR, "start_date": "2026-03-29"},
    {"name": "Dwars door Vlaanderen", "pcs_slug": "dwars-door-vlaanderen", "race_type": "one_day", "profile": "cobbled", "year": YEAR, "start_date": "2026-04-01"},
    # Classics — hilly/other
    {"name": "Eschborn-Frankfurt", "pcs_slug": "eschborn-frankfurt", "race_type": "one_day", "profile": "hilly", "year": YEAR, "start_date": "2026-05-01"},
    {"name": "Amstel Gold Race", "pcs_slug": "amstel-gold-race", "race_type": "one_day", "profile": "hilly", "year": YEAR, "start_date": "2026-04-19"},
    {"name": "La Flèche Wallonne", "pcs_slug": "la-fleche-wallonne", "race_type": "one_day", "profile": "hilly", "year": YEAR, "start_date": "2026-04-22"},
    {"name": "San Sebastián", "pcs_slug": "san-sebastian", "race_type": "one_day", "profile": "hilly", "year": YEAR, "start_date": "2026-08-01"},
    {"name": "Bretagne Classic", "pcs_slug": "bretagne-classic", "race_type": "one_day", "profile": "hilly", "year": YEAR, "start_date": "2026-08-29"},
    {"name": "GP Québec", "pcs_slug": "gp-quebec", "race_type": "one_day", "profile": "hilly", "year": YEAR, "start_date": "2026-09-11"},
    {"name": "GP Montréal", "pcs_slug": "gp-montreal", "race_type": "one_day", "profile": "hilly", "year": YEAR, "start_date": "2026-09-13"},
]
