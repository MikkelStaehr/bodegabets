...
// Bemærk: useLiveMatchesForGame er fjernet — gamerooms bruger nu useGameState
// (hooks/useGameState.tsx) som poller /api/games/[id]/state og dermed også
// inkluderer leaderboard og block-standings i samme request.
